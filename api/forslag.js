...
const MILJOER = [
  ...
  { navn: "Designhjelpen", kat: "Konsulent · Design", desc: "Designstudenter hjelper andre orgs og oppstarter med visuell identitet, web og UX.", match: "design, grafisk design, visuell identitet, logo, web, UX, interaksjonsdesign, produktdesign, kreativt, konsulent" },
  ...
  { navn: "Gründerbrakka", kat: "Coworking", desc: "Coworking-plass for ambisiøse oppstarter. Faste kontorplasser og investornettverk.", match: "coworking, kontorplass, oppstart, startup, gründer, inkubator, investornettverk, skalere" },
  ...
  { navn: "Innovatio", kat: "Linjeforening", desc: "Linjeforeningen for masterprogrammet i Innovasjon og bærekraftig samfunnsutvikling ved NTNU i Trondheim.", match: "linjeforening, innovasjon, bærekraft, samfunnsutvikling, sosialt, nettverk, master" },
  ...
  { navn: "Solan", kat: "Linjeforening", desc: "Linjeforeningen for Entreprenørskolen ved NTNU i Trondheim.", match: "linjeforening, sosialt, nettverk, arrangementer, entreprenørskap, Entreprenørskolen" },
  { navn: "Spark* NTNU", kat: "Veiledning", desc: "Gratis veiledningstjeneste for studenter med en forretningsidé — mentorer, workshops og et program fra post-it til pilot.", match: "veiledning, mentor, gründer, forretningsidé, oppstart, entreprenørskap, workshops, lavterskel" },
