...
const MILJOER = [
  ...
  { navn: "Spark* NTNU", kat: "Veiledning", desc: "NTNUs gratis veiledningstjeneste for studenter som har en forretningsidé eller vil starte noe eget. Kobler deg med mentorer, tilbyr workshops og et program som tar deg fra idé og post-it til pilot og oppstart. Det naturlige førstevalget for deg som har en forretningsidé, gründeridé eller startup-idé og trenger hjelp, veiledning, sparring eller noen å snakke med for å komme i gang – uansett hvor du er i prosessen." },
...
- Når brukeren har en forretningsidé, gründeridé eller startup-idé og trenger hjelp, veiledning eller vil starte noe eget, er «Spark* NTNU» det naturlige førstevalget (gratis veiledning fra idé til oppstart). Ta gjerne også med Start NTNU (miljø, events og pitching) og Entreprenørskolen (master der du bygger et reelt selskap) når de passer.
