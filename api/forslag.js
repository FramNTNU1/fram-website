...
const MILJOER = [
  ...
  { navn: "Boost Henne", kat: "Kvinnenettverk", desc: "Nettverk under Spark som motiverer og hjelper kvinnelige studenter inn i entreprenørskap og gründerskap. Tilbyr rollemodeller, mentorer, events og verktøy for jenter som vil starte noe eget. For kvinner som er nysgjerrige på oppstart og innovasjon." },
  { navn: "BRAIN NTNU", kat: "AI · Teknologi", desc: "Arrangerer hackathons, foredrag og møteplasser innen kunstig intelligens, og kobler studenter med forskningsmiljø og næringsliv. For deg som vil lære om KI, gå på AI-arrangementer og bli med på hackathon – ikke nødvendigvis bygge selv." },
